            ...
            <form action="">
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"><b>Alamat</b>
                  <p>Isikan alamat lahan parkir
                    Anda di bawah sini</p>
                </label>
                <input class="form-control text-center" type="text"
                  placeholder="Masukan link Maps lokasi alamat lahan parkir anda">
              </div>
              ...
              <a href="/vendor/vendor/Kelola-Kendaraan/layanan_step2"><button type="button"
