    ...
    <div class="row justify-content-center">
        <div class="card" style="background-color: #fff; width:80% ">
            <div class="card-body mt-3">
                <p>
                    <b>
                        Tambah layanan penitipan barang!!
                    </b>
                    <p class="text-muted">
                        Daftarkan gudang / tempat anda dengan mengisi data dibawah ini!
                    </p>
                </p>
                <br>
                <h6>
                    <svg  xmlns="http://www.w3.org/2000/svg" width="37px" height="37px" fill="currentColor"class="bi bi-1-circle-fill p-2" viewBox="0 0 16 16" style="color:rgb(255, 221, 0)">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <p class="">
                            Untuk mengatur lokasi dan detail
                            alamat vendor
                        </p>
                    </div>
                    @if ($step1)
                    ...
                    <div class="text-muted">
                        ...
                        <div class="row">
                            <div class="col-md-10 ">
                                <p class="">
                                    Mengatur jenis barang yang bisa dititipkan.
                                </p>
                            </div>
                            @if (!$step1)
