                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            {{-- <div class="container-fluid"> --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7 text-end">
                                        <button type="button" class="btn bg-white" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal"> Pilih</button>
                                        <!-- Modal -->
                                                    ...
                                                    <div class="card text-center">
                                                        <div class="card-body">
                                                            <h6 class="berhasil" style="padding-top: 5px; color: grey">
                                                                Pilih button dibawah ini karena sangat penting ketika
                                                                kamu belum mempunyai mobil pick up</h6>
                                                        </div>
                                                        <div class="d-grid gap-2 col-6 mx-auto">
                                                            <button type="button" class="btn btn-success"
                                                                data-bs-dismiss="modal">Pickup sendiri</button>
                                                            <button type="button" class="btn btn-success"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="card-body text-center">
                                                        ...
                                                        <h6 class="berhasil" style="padding-top: 5px; color: grey">
                                                            ...
                                                            lain untuk mengatasi masalah anda
                                                        </h6><br>
                                                        <div class="d-grid gap-2 col-6 mx-auto">
                                                            <button type="button" class="btn btn-success"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#exampleModal5">Pickup
                                                                sendiri</button><br>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="/Vendor/order/kendaraan/orderan_baru" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal24" class="btn btn-success">Ambil pesanan</a>
                                    <a class="btn btn-outline-secondary" href="/Vendor/order/kendaraan/orderan_baru"
                                        role="button">Tolak</a>
                                </div>
                                <!-- Modal -->
