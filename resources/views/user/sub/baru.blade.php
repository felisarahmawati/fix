...
@section('container')
    <section id="services" class="services section-bg" style="padding-top: 70px;" data-aos-delay="50" data-aos="fade-up">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="text-success"><b style="font-size: 16px">Rp 35.000/hari</b><br>
                    <small>
                      <span class="d-inline-block text-truncate text-muted" style="max-width: 230px;">
