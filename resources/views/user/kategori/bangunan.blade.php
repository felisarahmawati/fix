        ...
        <div class="container mt-2 mb-2">
            <div class="row row-layanan">
                <div class="col-lg-5 mt-5">
                    <figure class="figure">
                        <img src="{{ asset('assets/img/rumah1.jpg') }}" class="figure-img img-fluid" style="border-radius: 5px; width: 450px">
                    </figure>
                </div>
                <div class="col-lg-4">
                    <div class="nama-vendor">
                        <p class="fw-bold fs-5">Titip bangunan</p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="deskripsi overflow-scroll">
                            <p>Layanan penitipan barang dari Gudang Silubun dengan
                            </p>
                            <ul class="list-unstyled">
                                <li>Spesifikasi layanan:
                                  <ul>
                                    <li>Free cuci barang</li>
                                    <li>Barang dibersihkan setiap pagi</li>
                                    <li>Kontrol Barang</li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="d-grid gap-2 col-12 mx-auto mt-3">
                                    <a class="btn btn-outline-success btn-sm" href="/user/pemesanan/pemesananB" role="button">Pesan</a>
                                </div>
                            </div>
                        </div>
                    </div>
