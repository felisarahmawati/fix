    ...
    <div class="container mt-2 mb-2">
        <div class="row row-layanan">
            <div class="col-lg-5 mt-5">
                ...
                <figure class="figure">
                    <img src="{{ asset('assets/img/mtor4.jpg') }}" class="figure-img img-fluid" style="border-radius: 5px; width: 450px">
                    {{-- <figcaption class="figure-caption d-flex justify-content-evenly">
                        <a href="#">
                            <img src="{{ asset('assets/img/motor.jpg') }}" class="figure-img img-fluid" style="border-radius: 5px; width: 100px">
                        </a>
                        <a href="#">
                            <img src="{{ asset('assets/img/motor.jpg') }}" class="figure-img img-fluid" style="border-radius: 5px; width: 100px">
                        </a>
            ...
            <div class="col-lg-4">
                <div class="nama-vendor">
                    <p class="fw-bold">Pepi Penitipan</p>
                </div>
