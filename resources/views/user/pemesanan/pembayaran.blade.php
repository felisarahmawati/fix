    ...
    <div class="container mt-4 mb-4" data-aos="fade-up">
        <div class="row row-layanan">
            <p class="text-center fs-3">
                <small class="fw-bold">Menunggu Pembayaran</small>
            </p>
            <p class="text-center fs-6">
                Mohon selesaikan pembayaran Anda sebelum
                <small class="fw-bold">23 Oktober 2022 23:59 Wib</small><br>
            ...
            <p class="text-center fs-6 mt-3 fw-bold">
                ...
                <small class="text-muted">Jika jumlah yang ditransfer tidak sesuai,proses verifikasi pembayaran anda dapat terhambat</small>
            </p>
            <div class="mb-3" style="width: 35%; margin-left: 33%">
