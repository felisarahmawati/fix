    ...
    <div class="container mt-2 mb-2" data-aos="fade-up">
        <div class="row row-layanan">
            <ul class="nav nav-pills nav-fill mb-3">
                <li class="nav-item">
                  <a class="nav-link text-dark fw-bold" aria-current="page" href="/user/pemesanan/history/on_progress">Layanan Berlangsung</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-success fw-bold" aria-current="page" href="/user/pemesanan/history/last_progress">Layanan Selesai</a>
                </li>
            </ul>
        </div>
